 ...
 * Insert_Team_Name
 * Legal Player
 * Plays first move from list of moves received
 *
 */
public class INHLegalPlayer extends GGPlayer {
	...
	public static void main(String[] args) {
		Player.initialize(new INHLegalPlayer().getName());
	}
	...
	public Move play(long timeout)
		...
		Move chosenMove = legalMoves.get(legalMoves.size() - 1);
